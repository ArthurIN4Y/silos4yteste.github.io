...
import { DrawerStyled, Container, LogoContainer } from "./styles";
...
export const SideBar = () => {
  ...
  const MenuItems = [
    { Icon: HomeIcon, IconSelected: HomeIconYellow, Text: "Home", url: "/map-page" },
    {
      Icon: DashboardIcon,
    ...
    { Icon: UserIcon, IconSelected: UserIconYellow, Text: "Meus dados", url: "/profile"},
  ...
  return (
    <>
      <DrawerStyled variant="permanent" open={open}>
        <List sx={{ width: "100%" }}>
          {(!open && (
            <ListItemButton onClick={() => setOpen(true)} sx={{ padding: 0 }}>
